	...
	<div class="flex flex-col px-10 py-8 w-1/2 bg-white self-center mt-5">
		...
		<form action="login.do" method="POST" class="flex flex-col">
			<div class="flex items-center border rounded-lg mb-7 bg-gray-200 px-3">
				<input class="px-3 py-4 bg-transparent outline-none w-full" type="text" name="flight_number" placeholder="Número do Voo" required/>
			</div>
			
			<div class="flex items-center border rounded-lg mb-7 bg-gray-200 px-3">
				<input class="px-3 py-4 bg-transparent outline-none w-full" type="text" name="password" placeholder="Nome da Companhia Aérea" required/>
			</div>
			
			<div class="flex items-center border rounded-lg mb-7 bg-gray-200 px-3">
				<input class="px-3 py-4 bg-transparent outline-none w-full" type="datetime-local" name="password" placeholder="Horário de Chegada" required/>
			</div>
